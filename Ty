...
local Window = redzlib:MakeWindow({
  ...
  Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://113088956809836", BackgroundTransparency = 0 },
...
Tab1:AddDiscordInvite({
    Name = "FANTASMA Studio",
    Description = "entra ai",
    Logo = "rbxassetid://113088956809836",
    Invite = "https://discord.gg/E6WCkcgKY",
})
...
local Section = Tab1:AddSection({"versao do Hub v1"})
...
local Paragraph = Tab1:AddParagraph({"Criadores", "Lolyta \n ?????"})
  ...
  Tab1:AddButton({
    ...
    Callback = function()
      setclipboard("@gaga⚡") -- Copia o @
      setclipboard("tiktok.com/@isaac98538") -- Copia o link também, se quiser só o @, remova esta linha
